...
async function fetchExamConfig() {
    // ตรวจสอบว่าเปิดผ่าน Live Server (Port 5500) หรือไม่ ถ้าใช่ให้ชี้ไปที่เซิร์ฟเวอร์หลัก (Port 3000)
    const apiBase = window.location.port === '5500' ? `http://${window.location.hostname}:3000` : '';
    try {
